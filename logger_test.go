...
func TestApplication(t *testing.T) {
	...
	Error("This is error level error")
	Warn("This is warn level error")
	Info("This is info level error")
	Debug("This is debug level error")
	SetLevel(FatalLevel)
	//log.Fatal("This is fatal level error")
	Error("This is error level error")
	Warn("This is warn level error")
	Info("This is info level error")
	Debug("This is debug level error")
